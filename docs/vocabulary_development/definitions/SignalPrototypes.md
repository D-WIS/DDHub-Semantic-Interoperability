- Description: this is description set for specialization of signa prototypes.
...
- Attributes:
- Specialization:
- Description: Prototype signal for ActiveVolume.
- Examples:
```dwis activeVolume
...
- Attributes:
- Specialization:
- Description: Prototype signal for Azimuth.
- Examples:
```dwis azimuth
...
- Attributes:
- Specialization:
- Description: Prototype signal for DensityIn.
- Examples:
```dwis densityIn
...
- Attributes:
- Specialization:
- Description: Prototype signal for DensityOut.
- Examples:
```dwis densityOut
...
- Attributes:
- Specialization:
- Description: Prototype signal for DownholeECD.
- Examples:
```dwis downholeECD
...
- Attributes:
- Specialization:
- Description: Prototype signal for DownholePressure.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for DownholeRPM.
- Examples:
```dwis downholeRPM
...
- Attributes:
- Specialization:
- Description: Prototype signal for DownholeTemperature.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for DownholeTorque.
- Examples:
```dwis downholeTorque
...
- Attributes:
- Specialization:
- Description: Prototype signal for FlowRateIn.
- Examples:
```dwis flowRateIn
...
- Attributes:
- Specialization:
- Description: Prototype signal for FlowRateOut.
- Examples:
```dwis flowRateOut
...
- Attributes:
- Specialization:
- Description: Prototype signal for HoleDepth.
- Examples:
```dwis holeDepth
...
- Attributes:
- Specialization:
- Description: Prototype signal for HookLoad.
- Examples:
```dwis hookLoad
...
- Attributes:
- Specialization:
- Description: Prototype signal for HookPosition.
- Examples:
```dwis hookPosition
...
- Attributes:
- Specialization:
- Description: Prototype signal for HookVelocity.
- Examples:
```dwis hookVelocity
...
- Attributes:
- Specialization:
- Description: Prototype signal for Inclination.
- Examples:
```dwis inclination
...
- Attributes:
- Specialization:
- Description: Prototype signal for MeasuredDepth.
- Examples:
```dwis measuredDepth
...
- Attributes:
- Specialization:
- Description: Prototype signal for PumpRate.
- Examples:
```dwis pumpRate
...
- Attributes:
- Specialization:
- Description: Prototype signal for ROP.
- Examples:
```dwis rOP
...
- Attributes:
- Specialization:
- Description: Prototype signal for SPP.
- Examples:
```dwis sPP
...
- Attributes:
- Specialization:
- Description: Prototype signal for SurfaceRPM.
- Examples:
```dwis surfaceRPM
...
- Attributes:
- Specialization:
- Description: Prototype signal for SurfaceTorque.
- Examples:
```dwis surfaceTorque
...
- Attributes:
- Specialization:
- Description: Prototype signal for TemperatureIn.
- Examples:
```dwis temperatureIn
...
- Attributes:
- Specialization:
- Description: Prototype signal for TemperatureOut.
- Examples:
```dwis temperatureOut
...
- Attributes:
- Specialization:
- Description: Prototype signal for TopOfStringPosition.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for WOB.
- Examples:
```dwis wOB
...
- Attributes:
- Specialization:
- Description: Prototype signal for PorePressure.
- Examples:
```dwis porePressure
...
- Attributes:
- Specialization:
- Description: Prototype signal for PorePressureGradient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for FracturingPressure.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for FracturingPressureGradient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for CollapsePressure.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for CollapsePressureGradient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Shear rate.
- Examples:
```dwis shearRate
...
- Attributes:
- Specialization:
- Description: Prototype signal for Shear stress.
- Examples:
```dwis shearStress
...
- Attributes:
- Specialization:
- Description: Prototype signal for MinimumHorizontalStress.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for MinimumHorizontalStressGradient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for OverburdenPressure.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for OverburdenPressureGradient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for BOPOpening.
- Examples:
```dwis bOPOpening
...
- Attributes:
- Specialization:
- Description: Prototype signal for BOPPressure.
- Examples:
```dwis bOPPressure
...
- Attributes:
- Specialization:
- Description: Prototype signal for MPDChokeOpening.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for MPDChokePressure.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for MPDPumpRate.
- Examples:
```dwis mPDPumpRate
...
- Attributes:
- Specialization:
- Description: Prototype signal for MPDPumpFlowRate.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for GasFlowRate.
- Examples:
```dwis gasFlowRate
...
- Attributes:
- Specialization:
- Description: Prototype signal for BackPressurePumpPressure.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Mechanical Specific Energy.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Downhole Axial Acceleration.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Downhole Angular Acceleration.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Mechanical Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Static Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Kinetic Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Axial Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Rotational Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Hydraulic Friction coefficient.
- Examples:
...
- Attributes:
- Specialization:
- Description: Prototype signal for Annular Hydraulic Friction coefficient.
- Examples:
