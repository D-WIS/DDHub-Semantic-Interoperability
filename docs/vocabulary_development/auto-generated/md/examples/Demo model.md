...
flowchart TD
	...
	MudPump_0([MudPump_0]) --> PistonMudPumps[[PistonMudPumps]]:::typeClass
	MudPump_1([MudPump_1]) --> PistonMudPumps[[PistonMudPumps]]:::typeClass
	...
	DownholeECD_1([DownholeECD_1]) --> DownholeECD[[DownholeECD]]:::typeClass
	DynamicDrillingSignal_18([DynamicDrillingSignal_18]) --> DynamicDrillingSignal[[DynamicDrillingSignal]]:::typeClass
	HydraulicConnectedState_0([HydraulicConnectedState_0]) --> HydraulicConnectedState[[HydraulicConnectedState]]:::typeClass
	DrillingDataPoint_12([DrillingDataPoint_12]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DownholePressure_1([DownholePressure_1]) --> DownholePressure[[DownholePressure]]:::typeClass
	...
	DownholeECD_2([DownholeECD_2]) --> DownholeECD[[DownholeECD]]:::typeClass
	DownholePressure_3([DownholePressure_3]) --> DownholePressure[[DownholePressure]]:::typeClass
	DrillingDataPoint_17([DrillingDataPoint_17]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	NumberOfSampleMovingAverage_0([NumberOfSampleMovingAverage_0]) --> NumberOfSampleMovingAverage[[NumberOfSampleMovingAverage]]:::typeClass
	NumberOfSampleMovingAverage_1([NumberOfSampleMovingAverage_1]) --> NumberOfSampleMovingAverage[[NumberOfSampleMovingAverage]]:::typeClass
	...
	DirectTransformation_3([DirectTransformation_3]) --> DirectTransformation[[DirectTransformation]]:::typeClass
	MudPulseTelemetry_0([MudPulseTelemetry_0]) --> MudPulseTelemetry[[MudPulseTelemetry]]:::typeClass
	WiredPipeTelemetry_0([WiredPipeTelemetry_0]) --> WiredPipeTelemetry[[WiredPipeTelemetry]]:::typeClass
	...
	DrillingDataPoint_18([DrillingDataPoint_18]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_19([DrillingDataPoint_19]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_20([DrillingDataPoint_20]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	...
	DrillingDataPoint_21([DrillingDataPoint_21]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	HookLoad_1([HookLoad_1]) --> HookLoad[[HookLoad]]:::typeClass
	DrillingDataPoint_22([DrillingDataPoint_22]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_23([DrillingDataPoint_23]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	Transformation_4([Transformation_4]) --> Transformation[[Transformation]]:::typeClass
	...
	TimeWindowMovingAverage_7([TimeWindowMovingAverage_7]) --> TimeWindowMovingAverage[[TimeWindowMovingAverage]]:::typeClass
	TimeWindowMovingAverage_8([TimeWindowMovingAverage_8]) --> TimeWindowMovingAverage[[TimeWindowMovingAverage]]:::typeClass
	SurfaceRPM_1([SurfaceRPM_1]) --> SurfaceRPM[[SurfaceRPM]]:::typeClass
	Transformation_5([Transformation_5]) --> Transformation[[Transformation]]:::typeClass
	Transformation_6([Transformation_6]) --> Transformation[[Transformation]]:::typeClass
	TimeWindowMovingAverage_9([TimeWindowMovingAverage_9]) --> TimeWindowMovingAverage[[TimeWindowMovingAverage]]:::typeClass
	TimeWindowMovingAverage_10([TimeWindowMovingAverage_10]) --> TimeWindowMovingAverage[[TimeWindowMovingAverage]]:::typeClass
	Derivation_3([Derivation_3]) --> Derivation[[Derivation]]:::typeClass
	Transformation_7([Transformation_7]) --> Transformation[[Transformation]]:::typeClass
	DrillingDataPoint_24([DrillingDataPoint_24]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	...
	Transformation_8([Transformation_8]) --> Transformation[[Transformation]]:::typeClass
	DirectTransformation_4([DirectTransformation_4]) --> DirectTransformation[[DirectTransformation]]:::typeClass
	DrillingDataPoint_25([DrillingDataPoint_25]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	BitDepth_1([BitDepth_1]) --> BitDepth[[BitDepth]]:::typeClass
	DirectTransformation_5([DirectTransformation_5]) --> DirectTransformation[[DirectTransformation]]:::typeClass
	DrillingDataPoint_26([DrillingDataPoint_26]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	Location_0([Location_0]) --> Location[[Location]]:::typeClass
	DataFlowNode_3([DataFlowNode_3]) --> DataFlowNode[[DataFlowNode]]:::typeClass
	DrillingDataPoint_27([DrillingDataPoint_27]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	Location_1([Location_1]) --> Location[[Location]]:::typeClass
	DrillingDataPoint_28([DrillingDataPoint_28]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_29([DrillingDataPoint_29]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_30([DrillingDataPoint_30]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_31([DrillingDataPoint_31]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	DrillingDataPoint_32([DrillingDataPoint_32]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	Location_2([Location_2]) --> Location[[Location]]:::typeClass
	DrillingDataPoint_33([DrillingDataPoint_33]) --> DrillingDataPoint[[DrillingDataPoint]]:::typeClass
	 HookVelocity_0 -- HasValue --> DynamicDrillingSignal_0 
	 FlowRateIn_0 -- HasValue --> DynamicDrillingSignal_1 
	 BitDepth_0 -- HasValue --> DynamicDrillingSignal_2 
	 SurfaceRPM_0 -- HasValue --> DynamicDrillingSignal_3 
