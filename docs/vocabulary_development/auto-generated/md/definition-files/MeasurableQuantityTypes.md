...
```mermaid
graph LR
	N0000[ConsistencyIndexRheology_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[ConsistencyIndexRheology_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[ConsistencyIndexRheology_DataPoint] -->|HasValue| N0000[ConsistencyIndexRheology_Signal] 
	N0002[ConsistencyIndexRheology_DataPoint] -->|IsOfMeasurableQuantity| N0004[ConsistencyIndexRheologyQuantity] 
	N0000[ConsistencyIndexRheology_Signal] -->|HasUnitOfMeasure| N0005[PascalSecond] 
```
...
```mermaid
graph LR
	N0000[ElectricTension_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[ElectricTension_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[ElectricTension_DataPoint] -->|HasValue| N0000[ElectricTension_Signal] 
	N0002[ElectricTension_DataPoint] -->|IsOfMeasurableQuantity| N0004[ElectricTensionQuantity] 
	N0000[ElectricTension_Signal] -->|HasUnitOfMeasure| N0005[Volt] 
```
...
```mermaid
graph LR
	N0000[ImageScale_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[ImageScale_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[ImageScale_DataPoint] -->|HasValue| N0000[ImageScale_Signal] 
	N0002[ImageScale_DataPoint] -->|IsOfMeasurableQuantity| N0004[ImageScaleQuantity] 
	N0000[ImageScale_Signal] -->|HasUnitOfMeasure| N0005[DotPerMetre] 
```
...
```mermaid
graph LR
	N0000[DiameterSmall_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[DiameterSmall_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[DiameterSmall_DataPoint] -->|HasValue| N0000[DiameterSmall_Signal] 
	N0002[DiameterSmall_DataPoint] -->|IsOfMeasurableQuantity| N0004[DiameterSmallQuantity] 
	N0000[DiameterSmall_Signal] -->|HasUnitOfMeasure| N0005[Metre] 
```
...
```mermaid
graph LR
	N0000[DimensionLessStandard_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[DimensionLessStandard_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[DimensionLessStandard_DataPoint] -->|HasValue| N0000[DimensionLessStandard_Signal] 
	N0002[DimensionLessStandard_DataPoint] -->|IsOfMeasurableQuantity| N0004[DimensionLessStandardQuantity] 
	N0000[DimensionLessStandard_Signal] -->|HasUnitOfMeasure| N0005[Dimensionless] 
```
...
```mermaid
graph LR
	N0000[EarthMagneticFluxDensity_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[EarthMagneticFluxDensity_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[EarthMagneticFluxDensity_DataPoint] -->|HasValue| N0000[EarthMagneticFluxDensity_Signal] 
	N0002[EarthMagneticFluxDensity_DataPoint] -->|IsOfMeasurableQuantity| N0004[EarthMagneticFluxDensityQuantity] 
	N0000[EarthMagneticFluxDensity_Signal] -->|HasUnitOfMeasure| N0005[Tesla] 
```
...
```mermaid
graph LR
	N0000[ElasticModulus_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[ElasticModulus_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[ElasticModulus_DataPoint] -->|HasValue| N0000[ElasticModulus_Signal] 
	N0002[ElasticModulus_DataPoint] -->|IsOfMeasurableQuantity| N0004[ElasticModulusQuantity] 
	N0000[ElasticModulus_Signal] -->|HasUnitOfMeasure| N0005[Pascal] 
```
...
```mermaid
graph LR
	N0000[LengthSmall_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[LengthSmall_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[LengthSmall_DataPoint] -->|HasValue| N0000[LengthSmall_Signal] 
	N0002[LengthSmall_DataPoint] -->|IsOfMeasurableQuantity| N0004[LengthSmallQuantity] 
	N0000[LengthSmall_Signal] -->|HasUnitOfMeasure| N0005[Metre] 
```
...
```mermaid
graph LR
	N0000[RotationalFrequency_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[RotationalFrequency_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[RotationalFrequency_DataPoint] -->|HasValue| N0000[RotationalFrequency_Signal] 
	N0002[RotationalFrequency_DataPoint] -->|IsOfMeasurableQuantity| N0004[RotationalFrequencyQuantity] 
	N0000[RotationalFrequency_Signal] -->|HasUnitOfMeasure| N0005[Hertz] 
```
...
```mermaid
graph LR
	N0000[VolumeLarge_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[VolumeLarge_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[VolumeLarge_DataPoint] -->|HasValue| N0000[VolumeLarge_Signal] 
	N0002[VolumeLarge_DataPoint] -->|IsOfMeasurableQuantity| N0004[VolumeLargeQuantity] 
	N0000[VolumeLarge_Signal] -->|HasUnitOfMeasure| N0005[CubicMetre] 
```
...
```mermaid
graph LR
	N0000[ProportionStandard_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[ProportionStandard_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[ProportionStandard_DataPoint] -->|HasValue| N0000[ProportionStandard_Signal] 
	N0002[ProportionStandard_DataPoint] -->|IsOfMeasurableQuantity| N0004[ProportionStandardQuantity] 
	N0000[ProportionStandard_Signal] -->|HasUnitOfMeasure| N0005[Proportion] 
```
...
```mermaid
graph LR
	N0000[LengthStandard_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[LengthStandard_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[LengthStandard_DataPoint] -->|HasValue| N0000[LengthStandard_Signal] 
	N0002[LengthStandard_DataPoint] -->|IsOfMeasurableQuantity| N0004[LengthStandardQuantity] 
	N0000[LengthStandard_Signal] -->|HasUnitOfMeasure| N0005[Metre] 
```
...
```mermaid
graph LR
	N0000[FluidShearRate_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[FluidShearRate_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[FluidShearRate_DataPoint] -->|HasValue| N0000[FluidShearRate_Signal] 
	N0002[FluidShearRate_DataPoint] -->|IsOfMeasurableQuantity| N0004[FluidShearRateQuantity] 
	N0000[FluidShearRate_Signal] -->|HasUnitOfMeasure| N0005[Hertz] 
```
...
```mermaid
graph LR
	N0000[FluidShearStress_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[FluidShearStress_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[FluidShearStress_DataPoint] -->|HasValue| N0000[FluidShearStress_Signal] 
	N0002[FluidShearStress_DataPoint] -->|IsOfMeasurableQuantity| N0004[FluidShearStressQuantity] 
	N0000[FluidShearStress_Signal] -->|HasUnitOfMeasure| N0005[Pascal] 
```
...
```mermaid
graph LR
	N0000[TorqueSmall_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[TorqueSmall_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[TorqueSmall_DataPoint] -->|HasValue| N0000[TorqueSmall_Signal] 
	N0002[TorqueSmall_DataPoint] -->|IsOfMeasurableQuantity| N0004[TorqueSmallQuantity] 
	N0000[TorqueSmall_Signal] -->|HasUnitOfMeasure| N0005[NewtonMetre] 
```
...
```mermaid
graph LR
	N0000[RotationalFrequencySmall_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[RotationalFrequencySmall_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[RotationalFrequencySmall_DataPoint] -->|HasValue| N0000[RotationalFrequencySmall_Signal] 
	N0002[RotationalFrequencySmall_DataPoint] -->|IsOfMeasurableQuantity| N0004[RotationalFrequencySmallQuantity] 
	N0000[RotationalFrequencySmall_Signal] -->|HasUnitOfMeasure| N0005[Hertz] 
```
...
```mermaid
graph LR
	N0000[ProportionSmall_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[ProportionSmall_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[ProportionSmall_DataPoint] -->|HasValue| N0000[ProportionSmall_Signal] 
	N0002[ProportionSmall_DataPoint] -->|IsOfMeasurableQuantity| N0004[ProportionSmallQuantity] 
	N0000[ProportionSmall_Signal] -->|HasUnitOfMeasure| N0005[Proportion] 
```
...
```mermaid
graph LR
	N0000[Porosity_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[Porosity_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[Porosity_DataPoint] -->|HasValue| N0000[Porosity_Signal] 
	N0002[Porosity_DataPoint] -->|IsOfMeasurableQuantity| N0004[PorosityQuantity] 
	N0000[Porosity_Signal] -->|HasUnitOfMeasure| N0005[Proportion] 
```
...
```mermaid
graph LR
	N0000[StrokeFrequency_Signal] -->|BelongsToClass| N0001(DrillingSignal) 
	N0002[StrokeFrequency_DataPoint] -->|BelongsToClass| N0003(DrillingDataPoint) 
	N0002[StrokeFrequency_DataPoint] -->|HasValue| N0000[StrokeFrequency_Signal] 
	N0002[StrokeFrequency_DataPoint] -->|IsOfMeasurableQuantity| N0004[StrokeFrequencyQuantity] 
	N0000[StrokeFrequency_Signal] -->|HasUnitOfMeasure| N0005[Hertz] 
```
